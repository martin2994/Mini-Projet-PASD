...
static basic_type operator_subtraction_evaluate( chunk ch, va_list va){
    return operator_subtraction_operate( ch, va );
}

OPERATOR_BASIC_FULL( subtraction, subtraction )
